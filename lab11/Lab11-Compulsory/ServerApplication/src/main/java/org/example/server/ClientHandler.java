...
public class ClientHandler implements Runnable {
    ...
    private Player registerPlayer(BufferedReader inputFromClient, PrintWriter outputToClient)
        ...
        Player newPlayer = new Player(playerName, clientSocket, inputFromClient, outputToClient);
    ...
    private void playAllQuestions(Player currentPlayer) throws IOException {
        ...
        for (Question currentQuestion : gameState.getGameQuestions()) {
            ...
            String givenAnswer = readAnswerWithTimeout(currentPlayer);
    ...
    private String readAnswerWithTimeout(Player currentPlayer) throws IOException {
        clientSocket.setSoTimeout(ANSWER_TIMEOUT_MILLIS);
        long questionStartTime = System.currentTimeMillis();

        try {
            String answer = currentPlayer.getInputFromPlayer().readLine();
